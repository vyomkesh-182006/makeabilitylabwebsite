...
class PublicationAdmin(admin.ModelAdmin):
    ...
    # We want the talks easier to select. This is for github issue #553:
    # https://github.com/jonfroehlich/makeabilitylabwebsite/issues/553
    # I've found a few people talking about this but I can't get it to work
    #   See: https://stackoverflow.com/questions/34498673/what-are-some-alternative-for-modelchoicefield-for-large-number-of-choices?rq=1
    #   See also: https://pypi.org/project/django-easy-select2/1.2.2/
    # I'm trying to use Select2 django for this:
    #   See: https://django-select2.readthedocs.io/en/latest/get_started.html
    # formfield_overrides = {
...
# Uncomment and move this function to PublicationAdmin enable auto-entry from bibtex
